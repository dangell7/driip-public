...
int64_t hook(int64_t reserved ) {
    ...
    if (!equal)
    {
        ...
        accept(SBUF("Payroll: Incoming transaction"), 2);
    }
    ...
    if (amount_len != 8) {
        ...
        TRACESTR("Payroll: XRP SS transaction detected, computing % to send to rfPayroll");
        ...
        TRACESTR("Payroll: XRP Medicare tax transaction detected, computing % to send to rfPayroll");
